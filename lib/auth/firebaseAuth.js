...
let msg = {  
    ...
    android:{
        ...
        notification:{
            ...
            priority:'high',
            icon:"noti_icon",
            title:"Default_Title_Textasdf",
            body:"Default_Body_Textasdf",
...
const sendingPushmsg = async (req, res, next) =>{
    ...
    msg.android.notification.title="Default_Title_Textasdf";
    msg.android.notification.body="Default_Body_Textasdf";
    msg.android.notification.ticker="비즈북스알림";
    msg.data.URL="/";
    if(req.query.title)msg.android.notification.title=req.query.title;
    if(req.query.body)msg.android.notification.body=req.query.body;
    if(req.query.url)msg.data.URL=req.query.url;
    if(req.query.target){
        if(req.query.target=="ALL"){
            msg.topic=req.query.target;
        }else{
            msg.token=req.query.target;
        }
    }else{
